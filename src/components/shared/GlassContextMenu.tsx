      ...
      {isOpen && (
        <ContextMenuContext.Provider value={{ close }}>
          ...
          >
            {title && (
              <>
                <div className="select-none px-3 py-2 text-[11px] font-semibold uppercase tracking-widest text-muted-foreground/80">
                  {title}
                </div>
  ...
  return (
    <>
      ...
      >
        ...
        <div
          className={cn(
            "absolute bottom-2 left-[3px] top-2 w-[2px] rounded-full bg-primary/70 transition-opacity duration-200",
      ...
      {open &&
        createPortal(
          <div
            ref={menuRef}
            className={cn("bubble fixed z-[9999]", "flex flex-col", "min-w-[180px] py-1.5 px-1.5")}
            style={{
              left: subPos.x,
              top: subPos.y,
              opacity: ready ? 1 : 0,
...
export function ContextMenuLabel({
  ...
  return (
    <div
      className={cn(
        "select-none px-3 py-1.5 text-[11px] font-semibold uppercase tracking-widest text-muted-foreground/70",
        className,
      )}
    >
      {children}
