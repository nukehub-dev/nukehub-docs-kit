      ...
      {visible &&
        createPortal(
          <div
            ref={tooltipRef}
            className={cn(
              "pointer-events-none z-[9999] rounded-lg border border-border/80 bg-popover px-2.5 py-1.5 text-xs font-medium text-popover-foreground shadow-xl backdrop-blur-sm",
              className,
            )}
            style={{
              position: "fixed",
